...
from model_softmax import GRU, Conv2D, MaxPool2D, softmax, reLU, tanh, CrossEntropy, Optimizer, orthogonal_initializer
...
file_targets = open("../database/chb01-targets.txt", 'w')
...
file_Wall = open("all_param_3class.txt", 'w')
