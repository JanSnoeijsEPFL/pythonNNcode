...
file_Wall = open("all_param_test.txt", 'w')
...
for file_iter in range(startfile, nb_files+startfile):
    ...
    layer_2.change_input_size(seq_number,10,100)
    X_GRU_flat_augmented_test = np.ones((seq_number,10,1079))
    S_GRU_augmented_test = np.ones((seq_number,101))
    ...
    file2 = open("../results_test_full/{}_numPy_HS_WQon_ep40.txt".format(file_iter+1), 'w')
