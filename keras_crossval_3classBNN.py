...
from keras.layers import Dense, Conv2D, MaxPooling2D, GRU, TimeDistributed, Flatten, Softmax, Dropout, MaxPooling1D, Add, Input, Lambda
...
CVSF = open("../results_low_prec/cross_val_res_30e_noUPSAMPLING_dropoutPreGRU04.txt", 'w')
...
for index, (train_indices, val_indices) in enumerate(skf.split(X_new, Y_1D)):
    ...
    #perhaps not necessary (already Quantize activations at the end of the GRU layer
    #model.add(QuantizeWeights(100))
...
file2 = open("../results_low_prec/test_19to26_30ep_noUPSAMPLING_dropoutPreGRU04.txt", 'w')
...
TestSF = open("../results_low_prec/test_19to26_30ep_noUPSAMPLING_dropoutPreGRU04.txt", 'a')
